...
const Technologies = () => {
    return (
        <div className="border-b border-neutral-800 ">
            <h1 className="mt-10 mb-10 lg:mb-20  text-center text-4xl  bg-gradient-to-l from-pink-500  via-slate-500 to-purple-500 bg-clip-text text-transparent">Technologies</h1>
            <div className="flex flex-col items-center justify-center  text-white pb-40 lg:flex lg:flex-row lg:gap-8">
            <div className="p-6 backdrop-blur-sm bg-white/10 rounded-lg lg:mt-10 max-w-xs mb-10 hover:bg-slate-800 cursor-pointer ">
                    ...
                    <div className="p-6 backdrop-blur-sm bg-white/10 rounded-lg  max-w-xs mb-10 hover:bg-slate-800 cursor-pointer">
                    ...
                    <div className="p-6 backdrop-blur-sm bg-white/10 rounded-lg  max-w-xs mb-0 hover:bg-slate-800 cursor-pointer">
