...
const Contact = () => {
    ...
    return (
        <div className="border-b  border-neutral-900 pb-20">
            ...
            <h2 className="my-10 text-center text-xl">Feel free to reach out to me for any questions or opportunities!</h2>
            <div className=" flex flex-col items-center bg- py-6 mx-8 lg:mx-96">
